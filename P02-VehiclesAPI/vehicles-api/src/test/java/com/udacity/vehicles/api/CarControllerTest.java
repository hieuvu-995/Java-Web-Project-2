...
public class CarControllerTest {
    ...
    public void listCars() throws Exception {
         ...
         */
        Car car = getCar();
        car.getDetails().setModel("Toyota");
        ...
        mvc.perform(
                ...
                .andExpect(jsonPath("$._embedded.carList[0].details.model", is("Toyota")));
    }
    ...
    public void updateCar() throws Exception {
        Car car = getCar();
        car.getDetails().setModel("Vinfast");
        given(carService.save(any())).willReturn(car);
        mvc.perform(
                        put("/cars/1")
                                ...
                                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.details.model", is("Vinfast")));
